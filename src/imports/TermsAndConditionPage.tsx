...
function Frame9() {
  return (
    <div className="-translate-x-1/2 absolute bg-gradient-to-b from-white h-[730px] left-1/2 overflow-clip to-[#c4eeda] top-[3388px] w-[1920px]">
      <Frame19 />
    </div>
  );
}
...
function Frame25() {
  return (
    <div className="content-stretch flex flex-col gap-[20px] items-start relative shrink-0 w-full">
      <p className="font-['Helvetica_Now_Display:Medium',sans-serif] leading-[normal] relative shrink-0 text-[#111] text-[64px] w-full">Terms and Conditions</p>
      <div className="font-['Inter:Regular',sans-serif] font-normal leading-[30px] relative shrink-0 text-[#3c3c3c] text-[20px] w-full">
        <p className="mb-0">Welcome to the website of Daffodil Software Limited (“DSL”, “we”, “our”, or “us”).</p>
        <p>By accessing or using this website, you agree to comply with and be bound by the following Terms and Conditions. If you do not agree with any part of these terms, please discontinue use of the website.</p>
      </div>
    </div>
  );
}
...
function Frame24() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start justify-center relative shrink-0 w-full">
      <p className="font-['Helvetica_Now_Display:Medium',sans-serif] leading-[65px] relative shrink-0 text-[#111] text-[48px] w-full">1. About Daffodil Software Limited</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[30px] relative shrink-0 text-[#3c3c3c] text-[16px] w-full">Daffodil Software Limited is a Bangladesh-based software development company providing services including, but not limited to:</p>
      <ol className="block font-['Inter:Bold',sans-serif] font-bold leading-[0] relative shrink-0 text-[#3c3c3c] text-[16px] w-full" start="1">
        <li className="mb-0 ms-[24px]">
          <span className="leading-[30px]">Custom software development</span>
        </li>
        <li className="mb-0 ms-[24px]">
          <span className="leading-[30px]">ERP and business application solutions</span>
        </li>
        <li className="mb-0 ms-[24px]">
          <span className="leading-[30px]">Web and mobile application development</span>
        </li>
        <li className="mb-0 ms-[24px]">
          <span className="leading-[30px]">AI, automation, and emerging technology services</span>
        </li>
        <li className="ms-[24px]">
          <span className="leading-[30px]">IT consulting, maintenance, and support</span>
        </li>
      </ol>
    </div>
  );
...
function Frame29() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start justify-center relative shrink-0 w-full">
      <p className="font-['Helvetica_Now_Display:Medium',sans-serif] leading-[65px] relative shrink-0 text-[#111] text-[48px] w-full">2. Acceptance of Terms</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[30px] relative shrink-0 text-[#3c3c3c] text-[16px] w-full">By accessing this website, submitting any form, or communicating with DSL through digital channels, you acknowledge that you:</p>
      <ol className="block font-['Inter:Bold',sans-serif] font-bold leading-[0] relative shrink-0 text-[#3c3c3c] text-[16px] w-full" start="1">
        <li className="mb-0 ms-[24px]">
          <span className="leading-[30px]">Have read and understood these Terms and Conditions</span>
        </li>
        <li className="mb-0 ms-[24px]">
          <span className="leading-[30px]">Agree to be legally bound by them</span>
        </li>
        <li className="ms-[24px]">
          <span className="leading-[30px]">Are legally capable of entering into binding agreements</span>
        </li>
      </ol>
    </div>
  );
...
function Frame30() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start justify-center relative shrink-0 w-full">
      <p className="font-['Helvetica_Now_Display:Medium',sans-serif] leading-[65px] relative shrink-0 text-[#111] text-[48px] w-full">3. Use of Website Content</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[30px] relative shrink-0 text-[#3c3c3c] text-[16px] w-full">All content on this website—including text, graphics, visuals, case studies, UI samples, documents, and code snippets—is the intellectual property of Daffodil Software Limited unless otherwise stated.</p>
      <ol className="block font-['Inter:Bold',sans-serif] font-bold leading-[0] relative shrink-0 text-[#3c3c3c] text-[16px] w-full" start="1">
        <li className="mb-0 ms-[24px]">
          <span className="leading-[30px]">Custom software development</span>
        </li>
...
function Frame31() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start justify-center relative shrink-0 w-full">
      <p className="font-['Helvetica_Now_Display:Medium',sans-serif] leading-[65px] relative shrink-0 text-[#111] text-[48px] w-full">4. Intellectual Property Rights</p>
      <div className="font-['Inter:Regular',sans-serif] font-normal leading-[30px] relative shrink-0 text-[#3c3c3c] text-[16px] w-full">
        <p className="mb-0">All trademarks, service marks, logos, brand assets, methodologies, frameworks, and proprietary materials displayed on this website belong to Daffodil Software Limited or its licensors.</p>
        <p>Nothing on this website grants any license or right to use DSL intellectual property without prior written consent.</p>
      </div>
    </div>
  );
}
...
function Frame32() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start justify-center relative shrink-0 w-full">
      <p className="font-['Helvetica_Now_Display:Medium',sans-serif] leading-[65px] relative shrink-0 text-[#111] text-[48px] w-full">{`5. Service Information & Engagement Disclaimer`}</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[30px] relative shrink-0 text-[#3c3c3c] text-[16px] w-full">Information provided on this website is for general informational purposes only and does not constitute:</p>
      <ol className="block font-['Inter:Bold',sans-serif] font-bold leading-[0] relative shrink-0 text-[#3c3c3c] text-[16px] w-full" start="1">
        <li className="mb-0 ms-[24px]">
          <span className="leading-[30px]">A binding proposal</span>
        </li>
        <li className="mb-0 ms-[24px]">
          <span className="leading-[30px]">A fixed quotation</span>
        </li>
        <li className="mb-0 ms-[24px]">
          <span className="leading-[30px]">A service-level agreement (SLA)</span>
        </li>
        <li className="ms-[24px]">
          <span className="leading-[30px]">A contractual commitment</span>
        </li>
      </ol>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[30px] relative shrink-0 text-[#3c3c3c] text-[16px] w-full">Actual scope, pricing, timelines, and deliverables are defined only through formal agreements signed between DSL and the client.</p>
    </div>
  );
}
...
function Frame27() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start justify-center relative shrink-0 w-full">
      <p className="font-['Helvetica_Now_Display:Medium',sans-serif] leading-[65px] relative shrink-0 text-[#111] text-[48px] w-full">{`6. Client Communications & Submissions`}</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[30px] relative shrink-0 text-[#3c3c3c] text-[16px] w-full">By submitting contact forms, project inquiries, RFQs, or documents to DSL, you agree that:</p>
      <ol className="block font-['Inter:Bold',sans-serif] font-bold leading-[0] relative shrink-0 text-[#3c3c3c] text-[16px] w-full" start="1">
        <li className="mb-0 ms-[24px]">
          <span className="leading-[30px]">Information provided is accurate and lawful</span>
        </li>
        <li className="mb-0 ms-[24px]">
          <span className="leading-[30px]">DSL may use the information to respond to inquiries and assess project feasibility</span>
        </li>
        <li className="ms-[24px]">
          <span className="leading-[30px]">Submission does not create a client–vendor relationship unless formally agreed</span>
        </li>
      </ol>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[30px] relative shrink-0 text-[#3c3c3c] text-[16px] w-full">Confidential information should only be shared after a mutually signed NDA.</p>
    </div>
  );
}
...
function Frame33() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start justify-center relative shrink-0 w-full">
      <p className="font-['Helvetica_Now_Display:Medium',sans-serif] leading-[65px] relative shrink-0 text-[#111] text-[48px] w-full">{`7. Confidentiality & Data Protection`}</p>
      <div className="font-['Inter:Regular',sans-serif] font-normal leading-[30px] relative shrink-0 text-[#3c3c3c] text-[16px] w-full">
        <p className="mb-0">DSL is committed to protecting business and personal data.</p>
        <p className="mb-0">Any personal information shared through this website is handled in accordance with our Privacy Policy and applicable data protection laws.</p>
        <p className="mb-0">&nbsp;</p>
        <p>We implement reasonable administrative, technical, and organizational safeguards; however, no online transmission is fully risk-free.</p>
      </div>
    </div>
  );
}
...
function Frame34() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start justify-center relative shrink-0 w-full">
      <p className="font-['Helvetica_Now_Display:Medium',sans-serif] leading-[65px] relative shrink-0 text-[#111] text-[48px] w-full">8. Third-Party Links</p>
      <div className="font-['Inter:Regular',sans-serif] font-normal leading-[30px] relative shrink-0 text-[#3c3c3c] text-[16px] w-full">
        <p className="mb-0">This website may contain links to third-party websites for reference or convenience.</p>
        <p>DSL does not control, endorse, or assume responsibility for:</p>
      </div>
      <ol className="block font-['Inter:Bold',sans-serif] font-bold leading-[0] relative shrink-0 text-[#3c3c3c] text-[16px] w-full" start="1">
        <li className="mb-0 ms-[24px]">
          <span className="leading-[30px]">{` Third-party content or services`}</span>
        </li>
        <li className="mb-0 ms-[24px]">
          <span className="leading-[30px]">Privacy practices of external sites</span>
        </li>
        <li className="ms-[24px]">
          <span className="leading-[30px]">Any loss or damage arising from their use</span>
        </li>
      </ol>
    </div>
  );
...
function Frame35() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start justify-center relative shrink-0 w-full">
      <p className="font-['Helvetica_Now_Display:Medium',sans-serif] leading-[65px] relative shrink-0 text-[#111] text-[48px] w-full">9. Limitation of Liability</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[30px] relative shrink-0 text-[#3c3c3c] text-[16px] w-full">To the maximum extent permitted by law, Daffodil Software Limited shall not be liable for:</p>
      <ol className="block font-['Inter:Bold',sans-serif] font-bold leading-[0] relative shrink-0 text-[#3c3c3c] text-[16px] w-full" start="1">
        <li className="mb-0 ms-[24px]">
          <span className="leading-[30px]">Any direct or indirect loss arising from website use</span>
        </li>
        <li className="mb-0 ms-[24px]">
          <span className="leading-[30px]">Business interruption, data loss, or loss of profits</span>
        </li>
        <li className="ms-[24px]">
          <span className="leading-[30px]">Decisions made based on website content</span>
        </li>
      </ol>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[30px] relative shrink-0 text-[#3c3c3c] text-[16px] w-full">The website is provided on an “as-is” and “as-available” basis.</p>
    </div>
  );
}
...
function Frame36() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start justify-center relative shrink-0 w-full">
      <p className="font-['Helvetica_Now_Display:Medium',sans-serif] leading-[65px] relative shrink-0 text-[#111] text-[48px] w-full">10. Indemnification</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[30px] relative shrink-0 text-[#3c3c3c] text-[16px] w-full">You agree to indemnify and hold harmless Daffodil Software Limited, its directors, employees, and partners from any claims, damages, or liabilities arising from:</p>
      <ol className="block font-['Inter:Bold',sans-serif] font-bold leading-[0] relative shrink-0 text-[#3c3c3c] text-[16px] w-full" start="1">
        <li className="mb-0 ms-[24px]">
          <span className="leading-[30px]">Misuse of the website</span>
        </li>
        <li className="mb-0 ms-[24px]">
          <span className="leading-[30px]">Violation of these Terms</span>
        </li>
        <li className="ms-[24px]">
          <span className="leading-[30px]">Infringement of third-party rights</span>
        </li>
      </ol>
    </div>
  );
...
function Frame26() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[44px] items-start min-h-px min-w-px not-italic relative whitespace-pre-wrap">
      <Frame25 />
      <Frame24 />
      <Frame29 />
      <Frame30 />
...
function Frame28() {
  return (
    <div className="absolute content-stretch flex items-start left-[200px] top-[60px] w-[1520px]">
      <Frame26 />
    </div>
  );
}
...
export default function TermsAndConditionPage() {
  return (
    <div className="bg-white relative size-full" data-name="Terms and Condition Page">
      <Frame9 />
      <Frame28 />
    </div>
  );
