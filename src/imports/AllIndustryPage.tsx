import svgPaths from "../assets/svgs/svg-vdv8um9g7v";
...
function Frame61() {
  return (
    <div className="-translate-x-1/2 absolute bg-gradient-to-b from-white h-[730px] left-1/2 overflow-clip to-[#c4eeda] top-[2671px] w-[1920px]">
      <Frame73 />
    </div>
  );
}
  ...
  return (
    <div className="bg-white relative rounded-[80px] shrink-0">
      <div className="content-stretch flex flex-col items-center justify-center overflow-clip px-[16px] relative rounded-[inherit]">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[30px] not-italic relative shrink-0 text-[#333] text-[16px]">SIS</p>
      </div>
...
function Frame10() {
  return (
    <div className="bg-white relative rounded-[80px] shrink-0">
      <div className="content-stretch flex flex-col items-center justify-center overflow-clip px-[16px] relative rounded-[inherit]">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[30px] not-italic relative shrink-0 text-[#333] text-[16px]">LMS</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.1)] border-solid inset-0 pointer-events-none rounded-[80px]" />
    </div>
  );
...
function Frame11() {
  return (
    <div className="bg-white relative rounded-[80px] shrink-0">
      <div className="content-stretch flex flex-col items-center justify-center overflow-clip px-[16px] relative rounded-[inherit]">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[30px] not-italic relative shrink-0 text-[#333] text-[16px]">Academic ERP</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.1)] border-solid inset-0 pointer-events-none rounded-[80px]" />
    </div>
  );
...
function Frame71() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start justify-center overflow-clip relative shrink-0 w-full">
      ...
      <p className="font-['Helvetica_Now_Display:Regular',sans-serif] leading-[normal] min-w-full not-italic relative shrink-0 text-[16px] text-black w-[min-content] whitespace-pre-wrap">Academic, administrative, and learning systems built for scale, data accuracy, and operational efficiency.</p>
      <Frame13 />
    </div>
  );
}
...
function Frame16() {
  return (
    <div className="bg-white relative rounded-[80px] shrink-0">
      <div className="content-stretch flex flex-col items-center justify-center overflow-clip px-[16px] relative rounded-[inherit]">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[30px] not-italic relative shrink-0 text-[#333] text-[16px]">HMS</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.1)] border-solid inset-0 pointer-events-none rounded-[80px]" />
    </div>
  );
...
function Frame17() {
  return (
    <div className="bg-white relative rounded-[80px] shrink-0">
      <div className="content-stretch flex flex-col items-center justify-center overflow-clip px-[16px] relative rounded-[inherit]">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[30px] not-italic relative shrink-0 text-[#333] text-[16px]">Clinic Management</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.1)] border-solid inset-0 pointer-events-none rounded-[80px]" />
    </div>
  );
...
function Frame19() {
  return (
    <div className="bg-white relative rounded-[80px] shrink-0">
      <div className="content-stretch flex flex-col items-center justify-center overflow-clip px-[16px] relative rounded-[inherit]">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[30px] not-italic relative shrink-0 text-[#333] text-[16px]">Telemedicine</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.1)] border-solid inset-0 pointer-events-none rounded-[80px]" />
    </div>
  );
...
function Frame74() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start justify-center overflow-clip relative shrink-0 w-full">
      ...
      <p className="font-['Helvetica_Now_Display:Regular',sans-serif] leading-[normal] min-w-full not-italic relative shrink-0 text-[16px] text-black w-[min-content] whitespace-pre-wrap">Secure, compliant digital systems supporting hospitals, clinics, and healthcare operations.</p>
      <Frame15 />
    </div>
  );
}
...
function Frame22() {
  return (
    <div className="bg-white relative rounded-[80px] shrink-0">
      <div className="content-stretch flex flex-col items-center justify-center overflow-clip px-[16px] relative rounded-[inherit]">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[30px] not-italic relative shrink-0 text-[#333] text-[16px]">Inventory</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.1)] border-solid inset-0 pointer-events-none rounded-[80px]" />
    </div>
  );
...
function Frame23() {
  return (
    <div className="bg-white relative rounded-[80px] shrink-0">
      <div className="content-stretch flex flex-col items-center justify-center overflow-clip px-[16px] relative rounded-[inherit]">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[30px] not-italic relative shrink-0 text-[#333] text-[16px]">POS</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.1)] border-solid inset-0 pointer-events-none rounded-[80px]" />
    </div>
  );
...
function Frame24() {
  return (
    <div className="bg-white relative rounded-[80px] shrink-0">
      <div className="content-stretch flex flex-col items-center justify-center overflow-clip px-[16px] relative rounded-[inherit]">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[30px] not-italic relative shrink-0 text-[#333] text-[16px]">CRM</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.1)] border-solid inset-0 pointer-events-none rounded-[80px]" />
    </div>
  );
...
function Frame76() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start justify-center overflow-clip relative shrink-0 w-full">
      ...
      <p className="font-['Helvetica_Now_Display:Regular',sans-serif] leading-[normal] min-w-full not-italic relative shrink-0 text-[16px] text-black w-[min-content] whitespace-pre-wrap">Reliable, auditable platforms designed for governance, transparency, and nationwide deployment.</p>
      <Frame21 />
    </div>
  );
}
...
function Frame27() {
  return (
    <div className="bg-white relative rounded-[80px] shrink-0">
      <div className="content-stretch flex flex-col items-center justify-center overflow-clip px-[16px] relative rounded-[inherit]">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[30px] not-italic relative shrink-0 text-[#333] text-[16px]">Production Planning</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.1)] border-solid inset-0 pointer-events-none rounded-[80px]" />
    </div>
  );
...
function Frame28() {
  return (
    <div className="bg-white relative rounded-[80px] shrink-0">
      <div className="content-stretch flex flex-col items-center justify-center overflow-clip px-[16px] relative rounded-[inherit]">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[30px] not-italic relative shrink-0 text-[#333] text-[16px]">Procurement</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.1)] border-solid inset-0 pointer-events-none rounded-[80px]" />
    </div>
  );
...
function Frame29() {
  return (
    <div className="bg-white relative rounded-[80px] shrink-0">
      <div className="content-stretch flex flex-col items-center justify-center overflow-clip px-[16px] relative rounded-[inherit]">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[30px] not-italic relative shrink-0 text-[#333] text-[16px]">ERP</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.1)] border-solid inset-0 pointer-events-none rounded-[80px]" />
    </div>
  );
...
function Frame77() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start justify-center overflow-clip relative shrink-0 w-full">
      ...
      <p className="font-['Helvetica_Now_Display:Regular',sans-serif] leading-[normal] min-w-full not-italic relative shrink-0 text-[16px] text-black w-[min-content] whitespace-pre-wrap">ERP, workflow, and analytics systems tailored to complex organizational structures.</p>
      <Frame26 />
    </div>
  );
}
...
function Frame32() {
  return (
    <div className="bg-white relative rounded-[80px] shrink-0">
      <div className="content-stretch flex flex-col items-center justify-center overflow-clip px-[16px] relative rounded-[inherit]">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[30px] not-italic relative shrink-0 text-[#333] text-[16px]">Tenant Management</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.1)] border-solid inset-0 pointer-events-none rounded-[80px]" />
    </div>
  );
...
function Frame33() {
  return (
    <div className="bg-white relative rounded-[80px] shrink-0">
      <div className="content-stretch flex flex-col items-center justify-center overflow-clip px-[16px] relative rounded-[inherit]">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[30px] not-italic relative shrink-0 text-[#333] text-[16px]">Billing</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.1)] border-solid inset-0 pointer-events-none rounded-[80px]" />
    </div>
  );
...
function Frame34() {
  return (
    <div className="bg-white relative rounded-[80px] shrink-0">
      <div className="content-stretch flex flex-col items-center justify-center overflow-clip px-[16px] relative rounded-[inherit]">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[30px] not-italic relative shrink-0 text-[#333] text-[16px]">Maintanance</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.1)] border-solid inset-0 pointer-events-none rounded-[80px]" />
    </div>
  );
...
function Frame78() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start justify-center overflow-clip relative shrink-0 w-full">
      ...
      <p className="font-['Helvetica_Now_Display:Regular',sans-serif] leading-[normal] min-w-full not-italic relative shrink-0 text-[16px] text-black w-[min-content] whitespace-pre-wrap">Commerce, inventory, and customer experience solutions optimized for performance and growth.</p>
      <Frame31 />
    </div>
  );
}
...
function Frame37() {
  return (
    <div className="bg-white relative rounded-[80px] shrink-0">
      <div className="content-stretch flex flex-col items-center justify-center overflow-clip px-[16px] relative rounded-[inherit]">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[30px] not-italic relative shrink-0 text-[#333] text-[16px]">Asset management</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.1)] border-solid inset-0 pointer-events-none rounded-[80px]" />
    </div>
  );
...
function Frame38() {
  return (
    <div className="bg-white relative rounded-[80px] shrink-0">
      <div className="content-stretch flex flex-col items-center justify-center overflow-clip px-[16px] relative rounded-[inherit]">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[30px] not-italic relative shrink-0 text-[#333] text-[16px]">Banking</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.1)] border-solid inset-0 pointer-events-none rounded-[80px]" />
    </div>
  );
...
function Frame39() {
  return (
    <div className="bg-white relative rounded-[80px] shrink-0">
      <div className="content-stretch flex flex-col items-center justify-center overflow-clip px-[16px] relative rounded-[inherit]">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[30px] not-italic relative shrink-0 text-[#333] text-[16px]">Payroll</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.1)] border-solid inset-0 pointer-events-none rounded-[80px]" />
    </div>
  );
...
function Frame79() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start justify-center overflow-clip relative shrink-0 w-full">
      ...
      <p className="font-['Helvetica_Now_Display:Regular',sans-serif] leading-[normal] min-w-full not-italic relative shrink-0 text-[16px] text-black w-[min-content] whitespace-pre-wrap">Next-gen finance and banking systems that move money securely, manage risk intelligently, and scale effortlessly.</p>
      <Frame36 />
    </div>
  );
}
...
function Frame18() {
  return (
    <div className="-translate-x-1/2 absolute content-stretch flex flex-col gap-[60px] items-center justify-center left-1/2 px-[200px] py-[120px] top-[800px] w-[1920px]">
      <Frame82 />
      <Frame81 />
    </div>
  );
...
function Cta() {
  return (
    <div className="-translate-x-1/2 absolute bg-gradient-to-b from-white h-[872px] left-1/2 overflow-clip to-[#c4eeda] top-[1799px] w-[1920px]" data-name="CTA">
...
function Group() {
  return (
    <div className="absolute bottom-0 contents left-[-0.16px]">
      <div className="absolute bottom-0 flex h-[799.996px] items-center justify-center left-[-0.16px] w-[125px]">
        <div className="flex-none rotate-180">
          <div className="bg-gradient-to-b from-[rgba(255,255,255,0)] h-[799.996px] to-[rgba(74,196,240,0.3)] w-[125px]" />
        </div>
      </div>
      <div className="absolute bg-gradient-to-b bottom-0 from-[rgba(255,255,255,0)] h-[799.996px] left-[124.84px] to-[rgba(74,196,240,0.3)] w-[125px]" />
    </div>
  );
}
...
function Group1() {
  return (
    <div className="absolute bottom-0 contents left-[1670px]">
      <div className="absolute bg-gradient-to-b bottom-0 from-[rgba(255,255,255,0)] h-[799.996px] left-[1795px] to-[rgba(74,196,240,0.3)] w-[125px]" />
      <div className="absolute bottom-0 flex h-[799.996px] items-center justify-center left-[1670px] w-[125px]">
        <div className="flex-none rotate-180">
          <div className="bg-gradient-to-b from-[rgba(255,255,255,0)] h-[799.996px] to-[rgba(74,196,240,0.3)] w-[125px]" />
        </div>
      </div>
...
function Frame50() {
  return (
    <div className="content-stretch flex flex-col font-['Helvetica_Now_Display:Medium',sans-serif] items-center justify-center leading-[normal] pb-[20px] relative shrink-0 text-[64px] w-full">
      <p className="relative shrink-0">Industries We Build</p>
      <p className="relative shrink-0">Software For</p>
    </div>
  );
}
...
function Frame57() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-center justify-center not-italic relative shrink-0 text-white w-full">
      <Frame50 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[30px] relative shrink-0 text-[20px] text-center w-[1145px] whitespace-pre-wrap">We collaborate with organizations across diverse sectors, delivering software solutions shaped by real operational needs, regulatory environments, and user behavior. This page offers a quick overview of the industries we serve.</p>
    </div>
  );
}
...
function Frame8() {
  return (
    <div className="bg-[#01e067] content-stretch flex gap-[10px] h-full items-center overflow-clip pl-[24px] pr-[8px] py-[6px] relative rounded-[80px] shrink-0">
      ...
      <p className="font-['Helvetica_Now_Display:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#111] text-[16px]">See Our Industries</p>
      <Frame46 />
    </div>
  );
}
...
function Frame49() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute content-stretch flex flex-col gap-[40px] items-center justify-center left-1/2 top-1/2 w-[1520px]">
      <Frame55 />
      <div className="content-stretch flex h-[52px] items-center overflow-clip relative shrink-0" data-name="Primary CTA">
        <Frame8 />
      </div>
    ...
    <div className="absolute h-[800px] left-0 overflow-clip top-0 w-[1920px]">
      <div className="-translate-x-1/2 absolute flex h-[800px] items-center justify-center left-1/2 top-0 w-[1920px]" style={{ "--transform-inner-width": "1185", "--transform-inner-height": "0" } as React.CSSProperties}>
        <div className="flex-none rotate-90">
          <div className="h-[1920px] w-[800px]" data-name="image 76" style={{ backgroundImage: "linear-gradient(-1.71503e-06deg, rgba(0, 0, 0, 0.8) 46.196%, rgba(0, 0, 0, 0) 128.96%), linear-gradient(90deg, rgb(0, 66, 141) 0%, rgb(0, 66, 141) 100%)" }} />
        </div>
      </div>
      <Group />
      <Group1 />
...
export default function AllIndustryPage() {
  return (
    <div className="bg-white relative size-full" data-name="All Industry Page">
      <Frame61 />
      <Frame18 />
      <Cta />
      <Frame93 />
