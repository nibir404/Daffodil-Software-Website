import svgPaths from "./svg-an67zpi9vg";
...
function Frame39() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] items-start left-[24px] not-italic text-white top-[352px] w-[702px] whitespace-pre-wrap">
...
function Frame38() {
  return (
    <div className="bg-[#f6f6f6] flex-[1_0_0] h-[500px] min-h-px min-w-px relative rounded-[10px]">
      <div className="overflow-clip relative rounded-[inherit] size-full">
        <div className="absolute blur-[25px] h-[500px] left-0 top-0 w-[750px]" data-name="image 61">
...
function Frame80() {
  return (
    <div className="bg-[#f6f6f6] flex-[1_0_0] h-[500px] min-h-px min-w-px relative rounded-[10px]">
      <div className="overflow-clip relative rounded-[inherit] size-full">
        <div className="absolute blur-[27px] h-[500px] left-0 top-0 w-[750px]" data-name="image 61">
          <div aria-hidden="true" className="absolute inset-0 pointer-events-none">
...
function Frame41() {
  return (
    <div className="bg-[#f6f6f6] flex-[1_0_0] h-[500px] min-h-px min-w-px relative rounded-[10px]">
      <div className="overflow-clip relative rounded-[inherit] size-full">
        <div className="absolute blur-[27px] h-[500px] left-0 rounded-[10px] top-0 w-[750px]" data-name="image 61">
        ...
        <div className="absolute blur-[27px] h-[500px] left-0 rounded-[10px] top-0 w-[750px]" data-name="image 61">
          <div aria-hidden="true" className="absolute inset-0 pointer-events-none rounded-[10px]">
            <div className="absolute inset-0 overflow-hidden rounded-[10px]">
              <img alt="" className="absolute h-[150%] left-0 max-w-none top-[-25%] w-full" src={imgImage64} />
            </div>
            <div className="absolute bg-[rgba(0,0,0,0.5)] inset-0 rounded-[10px]" />
          </div>
        </div>
...
function Frame85() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[40px] items-start left-[200px] top-[290px] w-[1520px]">
      <Frame79 />
      <Frame81 />
      <Frame84 />
    </div>
...
function Frame2() {
  return (
    <div className="bg-gradient-to-r from-[#cfffe8] h-[44px] relative rounded-[100px] shrink-0 to-white">
      <div className="content-stretch flex flex-col h-full items-center justify-between overflow-clip px-[16px] py-[20px] relative rounded-[inherit]">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[30px] not-italic relative shrink-0 text-[#333] text-[16px]">All Blogs</p>
      </div>
...
function Frame3() {
  return (
    <div className="bg-white h-[44px] relative rounded-[80px] shrink-0">
      <div className="content-stretch flex flex-col h-full items-center justify-center overflow-clip px-[16px] relative rounded-[inherit]">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[30px] not-italic relative shrink-0 text-[#333] text-[16px]">{`AI & Intelligent Systems`}</p>
      </div>
...
function Frame4() {
  return (
    <div className="bg-white h-[44px] relative rounded-[80px] shrink-0">
      <div className="content-stretch flex flex-col h-full items-center justify-center overflow-clip px-[16px] relative rounded-[inherit]">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[30px] not-italic relative shrink-0 text-[#333] text-[16px]">{`Engineering & Architecture`}</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.1)] border-solid inset-0 pointer-events-none rounded-[80px]" />
    </div>
  );
...
function Frame53() {
  return (
    <div className="content-stretch flex items-center justify-between py-[10px] relative shrink-0 w-full">
      ...
      <p className="font-['Helvetica_Now_Display:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#333] text-[16px]">Select Your Blog Category</p>
      <ArrowDown2 />
    </div>
  );
}
...
function Frame58() {
  return (
    <div className="content-stretch flex items-start relative shrink-0 w-[450px]">
      <Frame55 />
    </div>
  );
}
...
function Frame88() {
  return (
    <div className="-translate-y-1/2 bg-white content-stretch flex items-center justify-between pointer-events-auto px-[200px] sticky top-0 w-[1920px]">
      <Frame48 />
      <Frame58 />
    </div>
  );
...
function Frame87() {
  return (
    <div className="bg-white h-[250px] pointer-events-auto sticky top-0 w-[1920px]">
      <div className="absolute bottom-0 h-[calc(100%-calc(50%+83px)+0px)] left-0 pointer-events-none top-[calc(50%+83px)]">
        <Frame88 />
      </div>
    </div>
  );
...
function Frame83() {
  return (
    <div className="absolute h-[1870px] left-0 top-[734px] w-[1920px]">
      <Frame85 />
      <div className="absolute bottom-0 h-[1870px] left-0 pointer-events-none top-0">
        <Frame87 />
      </div>
    </div>
  );
...
function Cta() {
  return (
    <div className="-translate-x-1/2 absolute bg-gradient-to-b from-white h-[872px] left-1/2 overflow-clip to-[#c4eeda] top-[2724px] w-[1920px]" data-name="CTA">
...
function Frame25() {
  return (
    <div className="-translate-x-1/2 absolute bg-gradient-to-b from-white h-[730px] left-1/2 overflow-clip to-[#c4eeda] top-[3596px] w-[1920px]">
      <Frame36 />
    </div>
  );
}
...
function Frame52() {
  return (
    <div className="absolute bg-gradient-to-b from-[#f5f5f7] h-[800px] left-0 overflow-clip to-[#b8f0d5] top-0 w-[1920px]">
      <Frame13 />
      <Frame75 />
    </div>
  );
...
export default function AllBlogPage() {
  return (
    <div className="bg-white relative size-full" data-name="All Blog Page">
      <Frame83 />
      <Cta />
      <Frame25 />
      <Frame52 />
