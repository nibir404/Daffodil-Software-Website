...
function Frame17() {
  return (
    <div className="content-stretch flex flex-col gap-[9px] items-start leading-[normal] not-italic relative shrink-0 w-full whitespace-pre-wrap">
      <p className="font-['Helvetica_Now_Display:Medium',sans-serif] relative shrink-0 text-[36px] text-black w-full">Product Categories</p>
      <p className="font-['Helvetica_Now_Display:Regular',sans-serif] relative shrink-0 text-[#3c3c3c] text-[16px] w-full">Products are organized by functional intent to help search engines and users understand scope without requiring interaction. Each category reflects a distinct operational domain.</p>
    </div>
  );
}
...
function Frame86() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full">
      <div className="bg-gradient-to-r from-[#cfffe8] relative shrink-0 to-white w-full" data-name="Product Category White">
        ...
        <div className="flex flex-row items-center size-full">
          <div className="content-stretch flex items-center justify-between px-[16px] py-[20px] relative w-full">
            <p className="font-['Helvetica_Now_Display:Bold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[24px] text-black">All Products</p>
              ...
              <div className="absolute bottom-1/2 left-[20.83%] right-[22.92%] top-1/2" data-name="Vector">
                <div className="absolute inset-[-0.75px_-8.33%]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10.5 1.5">
                    <path d="M9.75002 0.75H0.75" id="Vector" stroke="var(--stroke-0, #111111)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
                  </svg>
                </div>
              </div>
              <div className="absolute bottom-1/4 left-[54.17%] right-[20.83%] top-1/4" data-name="Vector">
                <div className="absolute inset-[-9.38%_-18.75%]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5.50005 9.5001">
                    <path d={svgPaths.p8187a80} id="Vector" stroke="var(--stroke-0, #111111)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
                  </svg>
                </div>
              </div>
            </div>
      ...
      <div className="relative shrink-0 w-full" data-name="Product Category White">
        <div className="flex flex-row items-center size-full">
          <div className="content-stretch flex items-center justify-between pr-[16px] py-[20px] relative w-full">
            <p className="font-['Helvetica_Now_Display:Bold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[24px] text-black">{`Enterprise & Operations Platforms`}</p>
            <div className="relative shrink-0 size-[16px]" data-name="Menu/arrow-right-02">
              <div className="absolute bottom-1/2 left-[20.83%] right-[22.92%] top-1/2" data-name="Vector">
                <div className="absolute inset-[-0.75px_-8.33%]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10.5 1.5">
      ...
      <div className="relative shrink-0 w-full" data-name="Product Category White">
        <div className="flex flex-row items-center size-full">
          <div className="content-stretch flex items-center justify-between pr-[16px] py-[20px] relative w-full">
            <p className="font-['Helvetica_Now_Display:Bold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[24px] text-black">Industry-Focused Management Systems</p>
            <div className="relative shrink-0 size-[16px]" data-name="Menu/arrow-right-02">
              <div className="absolute bottom-1/2 left-[20.83%] right-[22.92%] top-1/2" data-name="Vector">
                <div className="absolute inset-[-0.75px_-8.33%]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10.5 1.5">
      ...
      <div className="relative shrink-0 w-full" data-name="Product Category White">
        <div className="flex flex-row items-center size-full">
          <div className="content-stretch flex items-center justify-between pr-[16px] py-[20px] relative w-full">
            <p className="font-['Helvetica_Now_Display:Bold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[24px] text-black">{`Financial & Compliance Software`}</p>
            <div className="relative shrink-0 size-[16px]" data-name="Menu/arrow-right-02">
              <div className="absolute bottom-1/2 left-[20.83%] right-[22.92%] top-1/2" data-name="Vector">
                <div className="absolute inset-[-0.75px_-8.33%]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10.5 1.5">
      ...
      <div className="relative shrink-0 w-full" data-name="Product Category White">
        <div className="flex flex-row items-center size-full">
          <div className="content-stretch flex items-center justify-between pr-[16px] py-[20px] relative w-full">
            <p className="font-['Helvetica_Now_Display:Bold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[24px] text-black">{`Education & Institutional Solutions`}</p>
            <div className="relative shrink-0 size-[16px]" data-name="Menu/arrow-right-02">
              <div className="absolute bottom-1/2 left-[20.83%] right-[22.92%] top-1/2" data-name="Vector">
                <div className="absolute inset-[-0.75px_-8.33%]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10.5 1.5">
      ...
      <div className="relative shrink-0 w-full" data-name="Product Category White">
        <div className="flex flex-row items-center size-full">
          <div className="content-stretch flex items-center justify-between pr-[16px] py-[20px] relative w-full">
            <p className="font-['Helvetica_Now_Display:Bold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[24px] text-black">{`Healthcare & Service Management Tools`}</p>
            <div className="relative shrink-0 size-[16px]" data-name="Menu/arrow-right-02">
              <div className="absolute bottom-1/2 left-[20.83%] right-[22.92%] top-1/2" data-name="Vector">
                <div className="absolute inset-[-0.75px_-8.33%]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10.5 1.5">
      ...
      <div className="relative shrink-0 w-full" data-name="Product Category White">
        <div className="flex flex-row items-center size-full">
          <div className="content-stretch flex items-center justify-between pr-[16px] py-[20px] relative w-full">
            <p className="font-['Helvetica_Now_Display:Bold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[24px] text-black">{`Analytics, Automation & Intelligence Systems`}</p>
            <div className="relative shrink-0 size-[16px]" data-name="Menu/arrow-right-02">
              <div className="absolute bottom-1/2 left-[20.83%] right-[22.92%] top-1/2" data-name="Vector">
                <div className="absolute inset-[-0.75px_-8.33%]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10.5 1.5">
...
function Frame87() {
  return (
    <div className="absolute bottom-0 content-stretch flex flex-col gap-[35px] items-start left-0 w-[600px]">
      <Frame17 />
      <Frame86 />
    </div>
  );
...
function Frame89() {
  return (
    <div className="h-[871px] shrink-0 sticky top-0 w-[600px]">
      <Frame87 />
    </div>
  );
}
...
function Frame80() {
  return (
    <div className="bg-white h-[576px] relative rounded-[10px] shrink-0 w-full">
      ...
      <div className="content-stretch flex flex-col gap-[20px] items-start p-[40px] relative size-full">
        <Frame41 />
...
function Frame50() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-full">
      <div className="h-[50px] relative shrink-0 w-[150px]" data-name="image 65">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[234.11%] left-[-8.66%] max-w-none top-[-67.69%] w-[117%]" src={imgImage65} />
        </div>
      </div>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[23px] min-w-full not-italic relative shrink-0 text-[#3c3c3c] text-[16px] w-[min-content] whitespace-pre-wrap">Comprehensive hospital management system that integrates patient records, appointment scheduling, billing, pharmacy, and laboratory management into one seamless platform, improving healthcare delivery and operational efficiency.</p>
    </div>
  );
}
...
function Solutions5() {
  return (
    <div className="content-stretch flex gap-[10px] h-[50px] items-center py-[10px] relative shrink-0 w-full" data-name="Solutions">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.1)] border-b border-solid inset-0 pointer-events-none" />
      <p className="font-['Helvetica_Now_Display:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[20px] text-black">Hospital Modules</p>
    </div>
  );
}
...
function Solutions6() {
  return (
    <div className="content-stretch flex gap-[10px] h-[50px] items-center py-[10px] relative shrink-0 w-full" data-name="Solutions">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.1)] border-b border-solid inset-0 pointer-events-none" />
      <p className="font-['Helvetica_Now_Display:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[20px] text-black">Additional Hospital Modules</p>
    </div>
  );
}
...
function Solutions7() {
  return (
    <div className="content-stretch flex gap-[10px] h-[50px] items-center py-[10px] relative shrink-0 w-full" data-name="Solutions">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.1)] border-b border-solid inset-0 pointer-events-none" />
      <p className="font-['Helvetica_Now_Display:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[20px] text-black">Administrative Modules</p>
    </div>
  );
}
...
function Solutions8() {
  return (
    <div className="content-stretch flex gap-[10px] h-[50px] items-center py-[10px] relative shrink-0 w-full" data-name="Solutions">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.1)] border-b border-solid inset-0 pointer-events-none" />
      <p className="font-['Helvetica_Now_Display:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[20px] text-black">{`Accounting & Operational Modules`}</p>
    </div>
  );
}
...
function Solutions9() {
  return (
    <div className="content-stretch flex gap-[10px] h-[50px] items-center py-[10px] relative shrink-0 w-full" data-name="Solutions">
      <p className="font-['Helvetica_Now_Display:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[20px] text-black">{`Marketing & Communication`}</p>
    </div>
  );
}
...
function Frame73() {
  return (
    <div className="bg-[#ee1b24] h-[285px] overflow-clip relative rounded-[10px] shrink-0 w-[400px]">
      <div className="absolute bg-gradient-to-b bottom-0 from-[rgba(255,255,255,0)] h-[285px] left-0 to-[#ad0808] w-[53px]" />
      <div className="absolute bg-gradient-to-b bottom-0 from-[rgba(255,255,255,0)] h-[285px] left-[106px] to-[#ad0808] w-[53px]" />
      <div className="absolute bottom-0 flex h-[285px] items-center justify-center left-[53px] w-[53px]">
        <div className="flex-none rotate-180">
          <div className="bg-gradient-to-b from-[rgba(255,255,255,0)] h-[285px] to-[#ad0808] w-[53px]" />
        </div>
      </div>
      <div className="absolute h-[255px] left-[11px] top-[15px] w-[378px]" data-name="image 75">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImage75} />
...
function Frame52() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-full">
      <div className="h-[50px] relative shrink-0 w-[150px]" data-name="image 66">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[248.28%] left-[-45.63%] max-w-none top-[-67.17%] w-[123.96%]" src={imgImage66} />
        </div>
      </div>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[23px] min-w-full not-italic relative shrink-0 text-[#3c3c3c] text-[16px] w-[min-content] whitespace-pre-wrap">Integrated University Management System that transforms how universities operate with modules for student information, course management, examinations, finance, human resources, and research administration.</p>
    </div>
  );
}
...
function Solutions10() {
  return (
    <div className="content-stretch flex gap-[10px] h-[50px] items-center py-[10px] relative shrink-0 w-full" data-name="Solutions">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.1)] border-b border-solid inset-0 pointer-events-none" />
      <p className="font-['Helvetica_Now_Display:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[20px] text-black">Core Academic Modules</p>
    </div>
  );
}
...
function Solutions11() {
  return (
    <div className="content-stretch flex gap-[10px] h-[50px] items-center py-[10px] relative shrink-0 w-full" data-name="Solutions">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.1)] border-b border-solid inset-0 pointer-events-none" />
      <p className="font-['Helvetica_Now_Display:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[20px] text-black">Additional Academic Modules</p>
    </div>
  );
}
...
function Solutions14() {
  return (
    <div className="content-stretch flex gap-[10px] h-[50px] items-center py-[10px] relative shrink-0 w-full" data-name="Solutions">
      <p className="font-['Helvetica_Now_Display:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[20px] text-black">{`Marketing & Communication Modules`}</p>
    </div>
  );
}
...
function Frame74() {
  return (
    <div className="bg-[#0498b5] h-[285px] overflow-clip relative rounded-[10px] shrink-0 w-[400px]">
      <div className="absolute bg-gradient-to-b bottom-0 from-[rgba(255,255,255,0)] h-[285px] left-0 to-[#4ac4f0] w-[53px]" />
      <div className="absolute bg-gradient-to-b bottom-0 from-[rgba(255,255,255,0)] h-[285px] left-[106px] to-[#4ac4f0] w-[53px]" />
      <div className="absolute bottom-0 flex h-[285px] items-center justify-center left-[53px] w-[53px]">
        <div className="flex-none rotate-180">
...
function Frame54() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-full">
      <div className="h-[50px] relative shrink-0 w-[150px]" data-name="image 67">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[283.33%] left-[-45.83%] max-w-none top-[-91.67%] w-[141.67%]" src={imgImage67} />
        </div>
      </div>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[23px] min-w-full not-italic relative shrink-0 text-[#3c3c3c] text-[16px] w-[min-content] whitespace-pre-wrap">Comprehensive school and college management software designed to streamline educational institution operations and enhance learning experiences with features like attendance tracking, grade management, and so on.</p>
    </div>
  );
}
...
function Solutions15() {
  return (
    <div className="content-stretch flex gap-[10px] h-[50px] items-center py-[10px] relative shrink-0 w-full" data-name="Solutions">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.1)] border-b border-solid inset-0 pointer-events-none" />
      <p className="font-['Helvetica_Now_Display:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[20px] text-black">Academic Modules</p>
    </div>
  );
}
...
function Solutions17() {
  return (
    <div className="content-stretch flex gap-[10px] h-[50px] items-center py-[10px] relative shrink-0 w-full" data-name="Solutions">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.1)] border-b border-solid inset-0 pointer-events-none" />
      <p className="font-['Helvetica_Now_Display:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[20px] text-black">{`Accounting & Operational`}</p>
    </div>
  );
}
...
function Frame75() {
  return (
    <div className="bg-[#6f7d86] h-[285px] overflow-clip relative rounded-[10px] shrink-0 w-[400px]">
      <div className="absolute bg-gradient-to-b bottom-0 from-[rgba(255,255,255,0)] h-[285px] left-0 to-[#8c959a] w-[53px]" />
      <div className="absolute bg-gradient-to-b bottom-0 from-[rgba(255,255,255,0)] h-[285px] left-[106px] to-[#8c959a] w-[53px]" />
      <div className="absolute bottom-0 flex h-[285px] items-center justify-center left-[53px] w-[53px]">
        <div className="flex-none rotate-180">
          <div className="bg-gradient-to-b from-[rgba(255,255,255,0)] h-[285px] to-[#8c959a] w-[53px]" />
        </div>
      </div>
      <div className="absolute h-[255px] left-[11px] top-[15px] w-[378px]" data-name="image 75">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImage75} />
...
function Frame56() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-full">
      <div className="h-[50px] relative shrink-0 w-[150px]" data-name="image 68">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[272%] left-[-48.25%] max-w-none top-[-91.33%] w-[136.7%]" src={imgImage68} />
        </div>
      </div>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[23px] min-w-full not-italic relative shrink-0 text-[#3c3c3c] text-[16px] w-[min-content] whitespace-pre-wrap">All-in-one solution for streamlined payments, secure access management, and seamless campus operations for educational institutions with features for cashless transactions, attendance tracking, and library management.</p>
    </div>
  );
}
...
function Solutions19() {
  return (
    <div className="content-stretch flex gap-[10px] h-[50px] items-center py-[10px] relative shrink-0 w-full" data-name="Solutions">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.1)] border-b border-solid inset-0 pointer-events-none" />
      <p className="font-['Helvetica_Now_Display:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[20px] text-black">{` Payment Management`}</p>
    </div>
  );
}
...
function Solutions20() {
  return (
    <div className="content-stretch flex gap-[10px] h-[50px] items-center py-[10px] relative shrink-0 w-full" data-name="Solutions">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.1)] border-b border-solid inset-0 pointer-events-none" />
      <p className="font-['Helvetica_Now_Display:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[20px] text-black">{`Access & Permissions`}</p>
    </div>
  );
}

function Solutions21() {
  return (
    <div className="content-stretch flex gap-[10px] h-[50px] items-center py-[10px] relative shrink-0 w-full" data-name="Solutions">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.1)] border-b border-solid inset-0 pointer-events-none" />
      <p className="font-['Helvetica_Now_Display:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[20px] text-black">Security Features</p>
    </div>
  );
}

function Solutions22() {
  return (
    <div className="content-stretch flex gap-[10px] h-[50px] items-center py-[10px] relative shrink-0 w-full" data-name="Solutions">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.1)] border-b border-solid inset-0 pointer-events-none" />
      <p className="font-['Helvetica_Now_Display:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[20px] text-black">{`User Management & Administration`}</p>
    </div>
  );
}

function Solutions23() {
  return (
    <div className="content-stretch flex gap-[10px] h-[50px] items-center py-[10px] relative shrink-0 w-full" data-name="Solutions">
      <p className="font-['Helvetica_Now_Display:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[20px] text-black">{` Integration & Scalability`}</p>
    </div>
  );
}
...
function Frame76() {
  return (
    <div className="bg-[#f2a61a] h-[285px] overflow-clip relative rounded-[10px] shrink-0 w-[400px]">
      <div className="absolute bg-gradient-to-b bottom-0 from-[rgba(255,255,255,0)] h-[285px] left-0 to-[#ac740d] w-[53px]" />
      <div className="absolute bg-gradient-to-b bottom-0 from-[rgba(255,255,255,0)] h-[285px] left-[106px] to-[#ac740d] w-[53px]" />
      <div className="absolute bottom-0 flex h-[285px] items-center justify-center left-[53px] w-[53px]">
        <div className="flex-none rotate-180">
          <div className="bg-gradient-to-b from-[rgba(255,255,255,0)] h-[285px] to-[#ac740d] w-[53px]" />
        </div>
      </div>
      <div className="absolute h-[255px] left-[11px] top-[15px] w-[378px]" data-name="image 75">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImage75} />
...
function Frame58() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-full">
      <div className="h-[50px] relative shrink-0 w-[150px]" data-name="image 69">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[279.45%] left-[-53.8%] max-w-none top-[-89.73%] w-[139.51%]" src={imgImage69} />
        </div>
      </div>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[23px] min-w-full not-italic relative shrink-0 text-[#3c3c3c] text-[16px] w-[min-content] whitespace-pre-wrap">All-inclusive virtual event management solution that revolutionizes how events are organized and experienced in the digital space with features for registration, ticketing, virtual booths, networking, and analytics.</p>
    </div>
  );
}

function Solutions24() {
  return (
    <div className="content-stretch flex gap-[10px] h-[50px] items-center py-[10px] relative shrink-0 w-full" data-name="Solutions">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.1)] border-b border-solid inset-0 pointer-events-none" />
      <p className="font-['Helvetica_Now_Display:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[20px] text-black">{`Avatar & Interaction Features`}</p>
    </div>
  );
}

function Solutions25() {
  return (
    <div className="content-stretch flex gap-[10px] h-[50px] items-center py-[10px] relative shrink-0 w-full" data-name="Solutions">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.1)] border-b border-solid inset-0 pointer-events-none" />
      <p className="font-['Helvetica_Now_Display:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[20px] text-black">{`Virtual Venue & Environment Features`}</p>
    </div>
  );
}

function Solutions26() {
  return (
    <div className="content-stretch flex gap-[10px] h-[50px] items-center py-[10px] relative shrink-0 w-full" data-name="Solutions">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.1)] border-b border-solid inset-0 pointer-events-none" />
      <p className="font-['Helvetica_Now_Display:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[20px] text-black">{`Engagement & Gamification Features`}</p>
    </div>
  );
}

function Solutions27() {
  return (
    <div className="content-stretch flex gap-[10px] h-[50px] items-center py-[10px] relative shrink-0 w-full" data-name="Solutions">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.1)] border-b border-solid inset-0 pointer-events-none" />
      <p className="font-['Helvetica_Now_Display:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[20px] text-black">{`Content & Information Sharing`}</p>
    </div>
  );
}

function Solutions28() {
  return (
    <div className="content-stretch flex gap-[10px] h-[50px] items-center py-[10px] relative shrink-0 w-full" data-name="Solutions">
      <p className="font-['Helvetica_Now_Display:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[20px] text-black">Supportive Features</p>
    </div>
  );
}
...
function Frame77() {
  return (
    <div className="bg-[#ec465f] h-[285px] overflow-clip relative rounded-[10px] shrink-0 w-[400px]">
      <div className="absolute bg-gradient-to-b bottom-0 from-[rgba(255,255,255,0)] h-[285px] left-0 to-[#fd7e91] w-[53px]" />
      <div className="absolute bg-gradient-to-b bottom-0 from-[rgba(255,255,255,0)] h-[285px] left-[106px] to-[#fd7e91] w-[53px]" />
      <div className="absolute bottom-0 flex h-[285px] items-center justify-center left-[53px] w-[53px]">
        <div className="flex-none rotate-180">
          <div className="bg-gradient-to-b from-[rgba(255,255,255,0)] h-[285px] to-[#fd7e91] w-[53px]" />
        </div>
      </div>
      <div className="absolute h-[255px] left-[11px] top-[15px] w-[378px]" data-name="image 75">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImage75} />
...
function Frame60() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-full">
      <div className="h-[50px] relative shrink-0 w-[150px]" data-name="image 70">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[144.44%] left-[-47.14%] max-w-none top-[-23.33%] w-[134.04%]" src={imgImage70} />
        </div>
      </div>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[23px] min-w-full not-italic relative shrink-0 text-[#3c3c3c] text-[16px] w-[min-content] whitespace-pre-wrap">Study Abroad is an integrated foreign education consultancy management system that streamlines the entire international education process. By bringing students, agents, and universities together on a single digital platform, it enhances the efficiency, accessibility, and transparency of the global education system.</p>
    </div>
  );
}

function Solutions29() {
  return (
    <div className="content-stretch flex gap-[10px] h-[50px] items-center py-[10px] relative shrink-0 w-full" data-name="Solutions">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.1)] border-b border-solid inset-0 pointer-events-none" />
      <p className="font-['Helvetica_Now_Display:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[20px] text-black">Academic Modules</p>
...
function Solutions31() {
  return (
    <div className="content-stretch flex gap-[10px] h-[50px] items-center py-[10px] relative shrink-0 w-full" data-name="Solutions">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.1)] border-b border-solid inset-0 pointer-events-none" />
      <p className="font-['Helvetica_Now_Display:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[20px] text-black">{`Finance & Operations`}</p>
    </div>
  );
}

function Solutions32() {
  return (
    <div className="content-stretch flex gap-[10px] h-[50px] items-center py-[10px] relative shrink-0 w-full" data-name="Solutions">
      <p className="font-['Helvetica_Now_Display:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[20px] text-black">{`Marketing & Communication`}</p>
    </div>
...
function Frame78() {
  return (
    <div className="bg-[#61a3f3] h-[285px] overflow-clip relative rounded-[10px] shrink-0 w-[400px]">
      <div className="absolute bg-gradient-to-b bottom-0 from-[rgba(255,255,255,0)] h-[285px] left-0 to-[#9fcbff] w-[53px]" />
      <div className="absolute bg-gradient-to-b bottom-0 from-[rgba(255,255,255,0)] h-[285px] left-[106px] to-[#9fcbff] w-[53px]" />
      <div className="absolute bottom-0 flex h-[285px] items-center justify-center left-[53px] w-[53px]">
        <div className="flex-none rotate-180">
          <div className="bg-gradient-to-b from-[rgba(255,255,255,0)] h-[285px] to-[#9fcbff] w-[53px]" />
        </div>
      </div>
      <div className="absolute h-[255px] left-[11px] top-[15px] w-[378px]" data-name="image 75">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImage75} />
...
function Frame90() {
  return (
    <div className="absolute content-stretch flex gap-[60px] items-start left-[200px] top-[1536px] w-[1520px]">
      <Frame89 />
      <Frame88 />
    </div>
  );
...
function Frame8() {
  return (
    <div className="content-stretch flex flex-col font-['Helvetica_Now_Display:Medium',sans-serif] items-start leading-[normal] pb-[20px] relative shrink-0 text-[64px] w-full">
      <p className="relative shrink-0">Enterprise-Ready Platforms</p>
      <p className="relative shrink-0">Built for Real-World Operations</p>
    </div>
  );
}
...
function Frame11() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start not-italic relative shrink-0 text-white w-full">
      <Frame8 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[30px] relative shrink-0 text-[20px] w-[796px] whitespace-pre-wrap">A consolidated overview of Daffodil Software’s proprietary platforms and digital systems. Each product is developed to solve defined operational, industry, or workflow challenges—ranging from enterprise management to specialized business automation. This page exists to present the full product ecosystem in one searchable, structured location.</p>
    </div>
  );
}
...
function Frame79() {
  return (
    <div className="absolute h-[800px] left-0 overflow-clip top-0 w-[1920px]">
      <div className="-translate-x-1/2 absolute flex h-[800px] items-center justify-center left-1/2 top-0 w-[1920px]" style={{ "--transform-inner-width": "1185", "--transform-inner-height": "0" } as React.CSSProperties}>
        <div className="flex-none rotate-90">
          <div className="bg-[#173829] h-[1920px] w-[800px]" data-name="image 76" />
        </div>
      </div>
      <Frame9 />
    </div>
...
function Frame28() {
  return (
    <div className="-translate-x-1/2 absolute bg-gradient-to-b from-white h-[730px] left-1/2 overflow-clip to-[#c4eeda] top-[5855px] w-[1920px]">
      <Frame38 />
    </div>
  );
}
...
export default function AllProductPage() {
  return (
    <div className="bg-white relative size-full" data-name="All Product Page">
      <Frame90 />
      <Frame16 />
      <Frame79 />
