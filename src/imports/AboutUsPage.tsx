import svgPaths from "../assets/svgs/svg-ushoq3gy77";
...
import imgRectangle705 from "figma:asset/4adda5c41827bb8ec83608487fe9d913897f1776.png";
import imgRectangle706 from "figma:asset/0bdb471f4e78b61b083e8408c051d06192972efb.png";
import imgRectangle707 from "figma:asset/ad53edd4046b2da67540e75c68bc4793f58e55af.png";
import imgRectangle708 from "figma:asset/602b38c441ac5a0f07661ec373bea7e5bae3f212.png";
...
function Frame20() {
  return (
    <div className="content-stretch flex flex-col font-['Helvetica_Now_Display:Medium',sans-serif] items-start pb-[36px] relative shrink-0 text-[80px] w-full">
      ...
      <p className="leading-[0] relative shrink-0 text-[0px] text-black">
...
function Cta() {
  return (
    <div className="-translate-x-1/2 absolute bg-gradient-to-b from-white h-[747px] left-1/2 overflow-clip to-[#c4eeda] top-[6298px] w-[1920px]" data-name="CTA">
...
function Frame40() {
  return (
    <div className="absolute bg-gradient-to-b from-white h-[730px] left-0 overflow-clip to-[#c4eeda] top-[7045px] w-[1920px]">
      <Frame51 />
    </div>
  );
}
...
function Frame85() {
  return (
    <div className="absolute content-stretch flex gap-[40px] items-start left-[200px] top-[5638px]">
      <Frame84 />
...
function Frame22() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start justify-center min-h-px min-w-px relative">
      <p className="font-['Helvetica_Now_Display:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#111] text-[64px]">Our Way of Thinking</p>
    </div>
  );
}
...
function Frame28() {
  return (
    <div className="content-stretch flex gap-[24px] h-[138px] items-start relative shrink-0 w-full">
      <Frame22 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[30px] not-italic relative shrink-0 text-[#3c3c3c] text-[16px] w-[653px] whitespace-pre-wrap">Our thinking is grounded in how systems function over time, not how they appear at launch. We focus on clarity, structure, and long-term viability so what we build remains usable, adaptable, and dependable as organizations evolve.</p>
    </div>
  );
}
...
function Frame75() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-full">
      <Frame15 />
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[30px] min-w-full not-italic relative shrink-0 text-[20px] text-black w-[min-content] whitespace-pre-wrap">Context Before Code</p>
    </div>
  );
}
...
function Frame63() {
  return (
    <div className="bg-white flex-[1_0_0] h-[220px] min-h-px min-w-px relative rounded-[10px]">
      <div className="content-stretch flex flex-col items-start justify-between p-[20px] relative size-full">
        <Frame75 />
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[30px] not-italic relative shrink-0 text-[#3c3c3c] text-[16px] w-full whitespace-pre-wrap">Every system begins with understanding people, processes, constraints, and consequences.</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-full">
      ...
      <div className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[30px] min-w-full not-italic relative shrink-0 text-[20px] text-black w-[min-content] whitespace-pre-wrap">
        <p className="mb-0">{`Structure Over `}</p>
        <p>Shortcuts</p>
      </div>
    </div>
  );
...
function Frame65() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px min-w-px relative rounded-[10px] self-stretch">
      <div className="content-stretch flex flex-col items-start justify-between p-[20px] relative size-full">
        <Frame74 />
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[30px] not-italic relative shrink-0 text-[#3c3c3c] text-[16px] w-full whitespace-pre-wrap">We optimize for clarity, maintainability, and future change not speed alone.</p>
      </div>
    </div>
  );
}
...
function Frame73() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-full">
      <Frame17 />
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[30px] min-w-full not-italic relative shrink-0 text-[20px] text-black w-[min-content] whitespace-pre-wrap">Collaboration Without Dependency</p>
    </div>
  );
}
...
function Frame67() {
  return (
    <div className="bg-white flex-[1_0_0] h-[220px] min-h-px min-w-px relative rounded-[10px]">
      <div className="content-stretch flex flex-col items-start justify-between p-[20px] relative size-full">
        <Frame73 />
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[30px] not-italic relative shrink-0 text-[#3c3c3c] text-[16px] w-full whitespace-pre-wrap">We design systems teams can own, extend, and operate confidently.</p>
      </div>
    </div>
  );
}
...
function Frame72() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-full">
      <Frame18 />
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[30px] min-w-full not-italic relative shrink-0 text-[20px] text-black w-[min-content] whitespace-pre-wrap">Longevity as a Design Requirement</p>
    </div>
  );
}
...
function Frame64() {
  return (
    <div className="bg-white flex-[1_0_0] h-[220px] min-h-px min-w-px relative rounded-[10px]">
      <div className="content-stretch flex flex-col items-start justify-between p-[20px] relative size-full">
        <Frame72 />
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[30px] not-italic relative shrink-0 text-[#3c3c3c] text-[16px] w-full whitespace-pre-wrap">If it won’t make sense in three years, it doesn’t ship.</p>
      </div>
    </div>
  );
}
...
function Frame70() {
  return (
    <div className="-translate-x-1/2 absolute bg-[#f5f5f7] content-stretch flex flex-col items-start left-1/2 overflow-clip px-[200px] py-[120px] top-[1840px] w-[1920px]">
      <Frame71 />
    </div>
  );
}
...
function Frame69() {
  return (
    <div className="absolute content-stretch flex gap-[60px] items-center left-[200px] top-[1020px]">
...
function Frame88() {
  return (
    <div className="content-stretch flex flex-col font-['Helvetica_Now_Display:Medium',sans-serif] items-start leading-[normal] pb-[20px] relative shrink-0 text-[#111] text-[64px] w-full">
      <p className="relative shrink-0 w-full">{`What Clients Rely on `}</p>
      <p className="relative shrink-0 w-full">Us For</p>
    </div>
  );
}
...
function Frame81() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start not-italic relative shrink-0 w-full whitespace-pre-wrap">
      <Frame88 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[30px] relative shrink-0 text-[#3c3c3c] text-[16px] w-[504px]">Clients work with DSL when their software needs to become a stable foundation rather than a recurring problem.</p>
    </div>
  );
}
...
function Frame79() {
  return (
    <div className="content-stretch flex flex-col gap-[40px] items-start justify-center relative shrink-0 w-[639px]">
      <Frame81 />
      <PrimaryCta2 />
    </div>
  );
...
function Frame59() {
  return (
    <div className="content-stretch flex items-center py-[20px] relative shrink-0 w-full">
      ...
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[50px] min-h-px min-w-px not-italic relative text-[#111] text-[36px] whitespace-pre-wrap">Translating business intent into structured digital platforms</p>
    </div>
  );
}
...
function Frame60() {
  return (
    <div className="content-stretch flex items-center py-[20px] relative shrink-0 w-full">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.1)] border-b border-solid inset-0 pointer-events-none" />
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[50px] min-h-px min-w-px not-italic relative text-[#111] text-[36px] whitespace-pre-wrap">Designing systems that integrate across departments and data sources</p>
    </div>
  );
}
...
function Frame61() {
  return (
    <div className="content-stretch flex items-center py-[20px] relative shrink-0 w-full">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.1)] border-b border-solid inset-0 pointer-events-none" />
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[50px] min-h-px min-w-px not-italic relative text-[#111] text-[36px] whitespace-pre-wrap">Engineering solutions that remain operable under growth and change</p>
    </div>
  );
}
...
function Frame62() {
  return (
    <div className="content-stretch flex items-center py-[20px] relative shrink-0 w-full">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.1)] border-b border-solid inset-0 pointer-events-none" />
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[50px] min-h-px min-w-px not-italic relative text-[#111] text-[36px] whitespace-pre-wrap">Reducing operational friction through thoughtful system design</p>
    </div>
  );
}
...
function Frame58() {
  return (
    <div className="content-stretch flex flex-col items-start justify-center relative shrink-0 w-[821px]">
      <Frame59 />
      <Frame60 />
      <Frame61 />
      <Frame62 />
...
function Frame29() {
  return (
    <div className="-translate-x-1/2 absolute content-stretch flex gap-[60px] items-start left-1/2 top-[2618px] w-[1520px]">
      <Frame79 />
      <Frame58 />
    </div>
  );
...
function Frame30() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] items-center justify-center left-[460px] not-italic top-[120px] w-[1000px]">
      <p className="font-['Helvetica_Now_Display:Medium',sans-serif] leading-[normal] relative shrink-0 text-[#111] text-[64px]">The People Behind the Systems</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[30px] relative shrink-0 text-[#3c3c3c] text-[20px]">DSL is shaped by engineers, designers, analysts, and architects who think in systems rather than tasks.</p>
    </div>
  );
}
...
function Frame76() {
  return (
    <div className="absolute h-[500px] left-0 top-0 w-[430px]">
      <div className="absolute h-[500px] left-0 top-0 w-[430px]">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[120.4%] left-0 max-w-none top-[-0.05%] w-full" src={imgRectangle702} />
        </div>
      </div>
    </div>
  );
...
function OfficeImage() {
  return (
    <div className="h-[500px] relative rounded-[10px] shrink-0 w-[430px]" data-name="Office Image">
...
function Frame77() {
  return (
    <div className="absolute h-[500px] left-0 top-0 w-[430px]">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgFrame2085663686} />
      <div className="absolute h-[500px] left-0 top-0 w-[430px]">
        <div aria-hidden="true" className="absolute inset-0 pointer-events-none">
          <div className="absolute bg-[#d9d9d9] inset-0" />
          <div className="absolute inset-0 overflow-hidden">
            <img alt="" className="absolute h-full left-[-8.14%] max-w-none top-0 w-[116.28%]" src={imgRectangle703} />
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="absolute h-[500px] left-0 top-0 w-[430px]">
      <div className="absolute h-[500px] left-0 top-0 w-[430px]">
        <div aria-hidden="true" className="absolute inset-0 pointer-events-none">
          <div className="absolute bg-[#d9d9d9] inset-0" />
          <div className="absolute inset-0 overflow-hidden">
            <img alt="" className="absolute h-full left-[-50.39%] max-w-none top-0 w-[174.16%]" src={imgRectangle705} />
          </div>
        </div>
      </div>
    </div>
...
function OfficeImage2() {
  return (
    <div className="h-[500px] relative rounded-[10px] shrink-0 w-[430px]" data-name="Office Image">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[10px] size-full" src={imgOfficeImage} />
      <div className="overflow-clip relative rounded-[inherit] size-full">
        <Frame78 />
      </div>
      <div aria-hidden="true" className="absolute border-2 border-[rgba(0,0,0,0.1)] border-solid inset-[-2px] pointer-events-none rounded-[12px]" />
  ...
  return (
    <div className="absolute h-[500px] left-0 top-0 w-[430px]">
      <div className="absolute h-[500px] left-0 top-0 w-[430px]">
        <div aria-hidden="true" className="absolute inset-0 pointer-events-none">
          <div className="absolute bg-[#d9d9d9] inset-0" />
          <img alt="" className="absolute max-w-none object-cover size-full" src={imgRectangle706} />
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="absolute h-[500px] left-0 top-0 w-[430px]">
      <div className="absolute h-[500px] left-0 top-0 w-[430px]">
        <div aria-hidden="true" className="absolute inset-0 pointer-events-none">
          <div className="absolute bg-[#d9d9d9] inset-0" />
          <img alt="" className="absolute max-w-none object-cover size-full" src={imgRectangle707} />
        </div>
      </div>
    </div>
  );
...
function Frame89() {
  return (
    <div className="absolute content-stretch flex gap-[16px] items-center left-0 overflow-x-auto overflow-y-clip px-[200px] top-[328px] w-[1920px]">
      <OfficeImage />
      <OfficeImage1 />
      <OfficeImage2 />
      <OfficeImage3 />
...
function Frame80() {
  return (
    <div className="-translate-x-1/2 absolute bg-[#f5f5f7] h-[1000px] left-1/2 overflow-clip top-[4518px] w-[1920px]">
      <Frame30 />
      <Frame89 />
    </div>
  );
  ...
  return (
    <div className="absolute content-stretch flex flex-col gap-[60px] items-center left-[200px] top-[120px] w-[1520px]">
      ...
      <div className="h-[600px] relative rounded-[10px] shrink-0 w-full">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[10px] size-full" src={imgRectangle708} />
      </div>
      <SecondaryCta1 />
    </div>
  );
...
function Frame92() {
  return (
    <div className="-translate-x-1/2 absolute bg-[#0d1e32] h-[1220px] left-1/2 overflow-clip top-[3298px] w-[1920px]">
...
function AiBall() {
  return (
    <div className="absolute aspect-[300/300] left-[60.52%] overflow-clip right-[-18.23%] rounded-[941.8px] shadow-[0px_0px_853.16px_0px_rgba(44,246,152,0.75)] top-[-204px]" data-name="AI Ball" style={{ backgroundImage: "linear-gradient(-40.1009deg, rgb(55, 243, 211) 14.729%, rgb(20, 191, 143) 51.003%, rgb(185, 250, 213) 85.243%)" }}>
      ...
      <div className="absolute flex h-[163.941px] items-center justify-center left-[626.02px] top-[105.26px] w-[161.052px]" style={{ "--transform-inner-width": "1185", "--transform-inner-height": "154" } as React.CSSProperties}>
...
function Frame94() {
  return (
    <div className="absolute bg-[#f5f5f7] h-[800px] left-0 overflow-clip top-[100px] w-[1920px]">
      <AiBall />
      <Frame32 />
    </div>
  );
...
export default function AboutUsPage() {
  return (
    <div className="bg-white relative size-full" data-name="About Us Page">
      <Cta />
      <Frame40 />
      <Frame85 />
      <Frame70 />
