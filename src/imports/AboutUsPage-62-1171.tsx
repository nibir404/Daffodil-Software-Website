  ...
  return (
    <div className="backdrop-blur-[10px] h-[52px] relative rounded-[80px] shrink-0" data-name="Secondary CTA">
      <div className="content-stretch flex gap-[10px] h-full items-center overflow-clip px-[24px] py-[6px] relative rounded-[inherit]">
        <div className="-translate-x-1/2 absolute flex h-[130.588px] items-center justify-center left-[calc(50%-98.63px)] mix-blend-plus-lighter top-[-27.29px] w-[126.735px]" style={{ "--transform-inner-width": "1185", "--transform-inner-height": "21" } as React.CSSProperties}>
          <div className="flex-none rotate-[-46.28deg]">
            <div className="h-[30px] relative w-[152px]">
              <div className="absolute inset-[-180%_-35.53%]">
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 260 138">
...
function Cta() {
  return (
    <div className="-translate-x-1/2 absolute bg-gradient-to-b from-white h-[747px] left-1/2 overflow-clip to-[#c4eeda] top-[6198px] w-[1920px]" data-name="CTA">
...
function Frame36() {
  return (
    <div className="absolute bg-gradient-to-b from-white h-[730px] left-0 overflow-clip to-[#c4eeda] top-[6945px] w-[1920px]">
      <Frame47 />
    </div>
  );
}
...
function Frame79() {
  return (
    <div className="absolute content-stretch flex gap-[40px] items-start left-[200px] top-[5538px]">
      <Frame78 />
...
function Frame64() {
  return (
    <div className="-translate-x-1/2 absolute bg-[#f5f5f7] content-stretch flex flex-col items-start left-1/2 overflow-clip px-[200px] py-[120px] top-[1740px] w-[1920px]">
      <Frame65 />
    </div>
  );
}
...
function Frame63() {
  return (
    <div className="absolute content-stretch flex gap-[60px] items-center left-[200px] top-[920px]">
...
function Frame25() {
  return (
    <div className="-translate-x-1/2 absolute content-stretch flex gap-[60px] items-start left-1/2 top-[2518px] w-[1520px]">
      <Frame73 />
      <Frame52 />
    </div>
  );
...
function Frame74() {
  return (
    <div className="-translate-x-1/2 absolute bg-[#f5f5f7] h-[1000px] left-1/2 overflow-clip top-[4418px] w-[1920px]">
      <Frame26 />
      <Frame83 />
    </div>
  );
...
function SecondaryCta1() {
  return (
    <div className="backdrop-blur-[10px] h-[52px] relative rounded-[80px] shrink-0" data-name="Secondary CTA">
      <div className="content-stretch flex gap-[10px] h-full items-center overflow-clip px-[24px] py-[6px] relative rounded-[inherit]">
        <div className="-translate-x-1/2 absolute flex h-[130.588px] items-center justify-center left-[calc(50%-98.13px)] mix-blend-plus-lighter top-[-27.29px] w-[126.735px]" style={{ "--transform-inner-width": "1185", "--transform-inner-height": "21" } as React.CSSProperties}>
          <div className="flex-none rotate-[-46.28deg]">
            <div className="h-[30px] relative w-[152px]">
              <div className="absolute inset-[-180%_-35.53%]">
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 260 138">
...
function Frame86() {
  return (
    <div className="-translate-x-1/2 absolute bg-[#0d1e32] h-[1220px] left-1/2 overflow-clip top-[3198px] w-[1920px]">
...
function AiBall() {
  return (
    <div className="absolute aspect-[300/300] left-[60.52%] overflow-clip right-[-18.23%] rounded-[941.8px] shadow-[0px_0px_853.16px_0px_rgba(44,246,152,0.75)] top-[-204px]" data-name="AI Ball" style={{ backgroundImage: "linear-gradient(-40.1009deg, rgb(55, 243, 211) 14.729%, rgb(20, 191, 143) 51.003%, rgb(185, 250, 213) 85.243%)" }}>
      ...
      <div className="absolute flex h-[163.941px] items-center justify-center left-[626.02px] top-[105.26px] w-[161.052px]" style={{ "--transform-inner-width": "1185", "--transform-inner-height": "21" } as React.CSSProperties}>
...
function Frame88() {
  return (
    <div className="absolute bg-[#f5f5f7] h-[800px] left-0 overflow-clip top-0 w-[1920px]">
      <AiBall />
      <Frame28 />
    </div>
  );
...
// Export individual sections for flexible composition
export const HeroSection = Frame88;
export const OurWayOfThinkingSection = Frame64;
export const WhySoftwareBreaksSection = Frame63;
export const WhatClientsRelyOnSection = Frame25;
export const PeopleBehindSystemsSection = Frame74;
export const BuiltWithResponsibilitySection = Frame86;
export const VisionMissionSection = Frame79;
export const BottomCTASection = Cta;
export const FooterSection = Frame36;