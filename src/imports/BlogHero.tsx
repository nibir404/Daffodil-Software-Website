...
function Frame1() {
  return (
    <div className="content-stretch flex flex-col items-start justify-center relative shrink-0 w-[733px]">
      <Frame2 />
    </div>
  );
}
...
function Frame6() {
  return (
    <div className="h-[760px] relative shrink-0 w-[927px]">
...
function Frame10() {
  return (
    <div className="absolute content-stretch flex items-center justify-between left-[100px] top-[20px] w-[1800px]">
      <Frame1 />
      <Frame6 />
    </div>
  );
...
export default function BlogHero() {
  return (
    <div className="bg-gradient-to-b from-[#f5f5f7] relative size-full to-[#b8f0d5]" data-name="Blog Hero">
      <Frame10 />
    </div>
  );
}
