import svgPaths from "../assets/svgs/svg-0zwlo2xmpp";
...
export default function Cta() {
  return (
    <div className="bg-gradient-to-b from-white relative w-full overflow-hidden to-[#c4eeda]" data-name="CTA">
      <div className="-translate-y-1/2 absolute h-[872px] left-0 top-1/2 w-full max-w-[1920px]" data-name="image 57">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[137.61%] left-0 max-w-none top-[-27.75%] w-full" src={imgImage57} />
        </div>
      </div>
      <div className="-translate-x-1/2 absolute flex items-center justify-center left-[calc(50%+1134.5px)] size-[1337px] top-[50px] opacity-0">
