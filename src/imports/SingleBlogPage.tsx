...
function Frame58() {
  return (
    <div className="h-[486px] pointer-events-auto sticky top-0 w-[390px]">
      <Frame11 />
    </div>
  );
}
...
function Frame55() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[60px] items-start left-[650px] py-[120px] top-[440px] w-[1070px]">
      <Frame44 />
      <Frame49 />
      <Frame50 />
...
function Frame16() {
  return (
    <div className="-translate-x-1/2 absolute bg-gradient-to-b from-white h-[730px] left-1/2 overflow-clip to-[#c4eeda] top-[4103px] w-[1920px]">
      <Frame26 />
    </div>
  );
}
...
function Frame29() {
  return (
    <div className="-translate-x-1/2 absolute bg-[#f5f5f7] h-[1148px] left-1/2 overflow-clip top-[2955px] w-[1920px]">
      <Frame37 />
    </div>
  );
}
...
function Frame48() {
  return (
    <div className="absolute h-[440px] left-0 top-0 w-[1920px]">
      <div aria-hidden="true" className="absolute inset-0 pointer-events-none">
...
export default function SingleBlogPage() {
  return (
    <div className="bg-white relative size-full" data-name="Single Blog Page">
      <div className="absolute bottom-0 h-[4393px] left-[200px] pointer-events-none top-[440px]">
        <Frame58 />
      </div>
      <Frame55 />
      <Frame16 />
