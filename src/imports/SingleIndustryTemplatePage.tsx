import svgPaths from "./svg-oc3bcnf80y";
...
function Frame30() {
  return (
    <div className="-translate-x-1/2 absolute content-stretch flex flex-col gap-[24px] items-center justify-center left-1/2 not-italic text-center text-white top-[120px] w-[1520px] whitespace-pre-wrap">
      <p className="font-['Helvetica_Now_Display:Medium',sans-serif] leading-[75px] relative shrink-0 text-[64px] w-[1014px]">A Technology Partner That Understands Academic Operations</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[30px] relative shrink-0 text-[16px] w-[864px]">Universities choose Daffodil Software Limited because we focus on operational fit, not generic software delivery.</p>
    </div>
  );
}
...
function Frame115() {
  return (
    <div className="content-stretch flex gap-[100px] items-start relative shrink-0 text-[30px] w-[610px]">
      <p className="leading-[30px] relative shrink-0 text-center">01</p>
      <p className="leading-[40px] relative shrink-0 w-[467px] whitespace-pre-wrap">Experience building large-scale academic and ERP systems</p>
    </div>
  );
}
  ...
  return (
    <div className="bg-[rgba(255,255,255,0.05)] relative shrink-0 w-full">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex font-['Inter:Regular',sans-serif] font-normal items-center justify-between not-italic px-[40px] py-[20px] relative text-white w-full">
          <Frame115 />
          <p className="leading-[30px] relative shrink-0 text-[16px] w-[400px] whitespace-pre-wrap">Proven experience delivering systems that handle complex academic structures and high student volumes.</p>
        </div>
      </div>
    </div>
  );
...
function Frame119() {
  return (
    <div className="content-stretch flex gap-[100px] items-start relative shrink-0 text-[30px] w-[610px]">
      <p className="leading-[30px] relative shrink-0 text-center">02</p>
      <p className="leading-[40px] relative shrink-0 w-[467px] whitespace-pre-wrap">Custom workflows aligned with university policies</p>
    </div>
  );
}
  ...
  return (
    <div className="bg-[rgba(255,255,255,0.05)] relative shrink-0 w-full">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex font-['Inter:Regular',sans-serif] font-normal items-center justify-between not-italic px-[40px] py-[20px] relative text-white w-full">
          <Frame119 />
          <p className="leading-[30px] relative shrink-0 text-[16px] w-[400px] whitespace-pre-wrap">Processes are tailored to institutional rules, approvals, and academic regulations—not forced templates.</p>
        </div>
      </div>
    </div>
  );
...
function Frame121() {
  return (
    <div className="content-stretch flex gap-[100px] items-start relative shrink-0 text-[30px] w-[610px]">
      <p className="leading-[30px] relative shrink-0 text-center">03</p>
      <p className="leading-[40px] relative shrink-0 w-[467px] whitespace-pre-wrap">UX designed for non-technical academic users</p>
    </div>
  );
}
  ...
  return (
    <div className="bg-[rgba(255,255,255,0.05)] relative shrink-0 w-full">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex font-['Inter:Regular',sans-serif] font-normal items-center justify-between not-italic px-[40px] py-[20px] relative text-white w-full">
          <Frame121 />
          <p className="leading-[30px] relative shrink-0 text-[16px] w-[400px] whitespace-pre-wrap">Interfaces are simple and intuitive so faculty and staff can work confidently without technical training.</p>
        </div>
      </div>
    </div>
  );
...
function Frame123() {
  return (
    <div className="content-stretch flex gap-[100px] items-start relative shrink-0 text-[30px] w-[610px]">
      <p className="leading-[30px] relative shrink-0 text-center">04</p>
      <p className="leading-[40px] relative shrink-0 w-[467px] whitespace-pre-wrap">Scalable architecture for growing student populations</p>
    </div>
  );
}
  ...
  return (
    <div className="bg-[rgba(255,255,255,0.05)] relative shrink-0 w-full">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex font-['Inter:Regular',sans-serif] font-normal items-center justify-between not-italic px-[40px] py-[20px] relative text-white w-full">
          <Frame123 />
          <p className="leading-[30px] relative shrink-0 text-[16px] w-[400px] whitespace-pre-wrap">Systems are built to support increasing enrollment, new programs, and multi-campus expansion.</p>
        </div>
      </div>
    </div>
  );
...
function Frame125() {
  return (
    <div className="content-stretch flex gap-[100px] items-start relative shrink-0 text-[30px] w-[610px]">
      <p className="leading-[30px] relative shrink-0 text-center">05</p>
      <p className="leading-[40px] relative shrink-0 w-[467px] whitespace-pre-wrap">Long-term partnership for enhancement and support</p>
    </div>
  );
}
  ...
  return (
    <div className="bg-[rgba(255,255,255,0.05)] relative shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex font-['Inter:Regular',sans-serif] font-normal items-center justify-between not-italic px-[40px] py-[20px] relative text-white w-full">
          <Frame125 />
          <p className="leading-[30px] relative shrink-0 text-[16px] w-[400px] whitespace-pre-wrap">We stay involved beyond launch to improve, scale, and support the system as needs evolve.</p>
        </div>
      </div>
    </div>
  );
...
function Frame118() {
  return (
    <div className="absolute left-[200px] rounded-[10px] top-[384px] w-[1520px]">
      <div className="content-stretch flex flex-col items-start overflow-clip relative rounded-[inherit] w-full">
        ...
        <Frame122 />
        <Frame124 />
        <div className="bg-[#01e067] content-stretch flex h-[120px] items-center justify-between overflow-clip px-[40px] py-[6px] relative rounded-[10px] shrink-0 w-[1520px]">
          <div className="-translate-x-1/2 absolute flex h-[292.036px] items-center justify-center left-[calc(50%-683.89px)] mix-blend-plus-lighter top-[-105.89px] w-[636.657px]" style={{ "--transform-inner-width": "1185", "--transform-inner-height": "154" } as React.CSSProperties}>
...
function Frame105() {
  return (
    <div className="absolute bg-[#0b386c] h-[1244px] left-0 overflow-clip top-[4073px] w-[1920px]">
      <Frame30 />
      <Frame118 />
    </div>
  );
...
function Frame111() {
  return (
    <div className="content-stretch flex items-center justify-between not-italic relative shrink-0 w-full whitespace-pre-wrap">
      <p className="font-['Helvetica_Now_Display:Medium',sans-serif] leading-[75px] relative shrink-0 text-[#111] text-[64px] w-[638px]">How Universities Use This System</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[30px] relative shrink-0 text-[#3c3c3c] text-[16px] w-[412px]">This system supports core university operations from student admissions to academic records and financial management helping institutions reduce manual work and maintain consistent, reliable data.</p>
    </div>
  );
}
...
function Frame114() {
  return (
    <div className="content-stretch flex gap-[16px] items-center pointer-events-none relative shrink-0">
      <div className="h-[538px] relative rounded-[10px] shrink-0 w-[526px]">
        <img alt="" className="absolute inset-0 max-w-none object-cover rounded-[10px] size-full" src={imgRectangle687} />
        <div aria-hidden="true" className="absolute border-2 border-[rgba(0,0,0,0.1)] border-solid inset-[-2px] rounded-[12px]" />
      </div>
      <div className="h-[538px] relative rounded-[10px] shrink-0 w-[526px]">
        <img alt="" className="absolute inset-0 max-w-none object-cover rounded-[10px] size-full" src={imgRectangle688} />
        <div aria-hidden="true" className="absolute border-2 border-[rgba(0,0,0,0.1)] border-solid inset-[-2px] rounded-[12px]" />
      </div>
    </div>
  );
...
function Frame106() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-center min-h-px min-w-px py-[10px] relative w-full">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.1)] border-b border-solid inset-0 pointer-events-none" />
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[30px] min-h-px min-w-px not-italic relative text-[24px] text-black whitespace-pre-wrap">Automating admissions, registration, and fee collection</p>
    </div>
  );
}
...
function Frame107() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-center min-h-px min-w-px py-[10px] relative w-full">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.1)] border-b border-solid inset-0 pointer-events-none" />
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[30px] min-h-px min-w-px not-italic relative text-[24px] text-black whitespace-pre-wrap">Managing exams, grading, certificates, and transcripts</p>
    </div>
  );
}
...
function Frame109() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-center min-h-px min-w-px py-[10px] relative w-full">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.1)] border-b border-solid inset-0 pointer-events-none" />
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[30px] min-h-px min-w-px not-italic relative text-[24px] text-black whitespace-pre-wrap">Centralizing academic, administrative, and financial data</p>
    </div>
  );
}
...
function Frame110() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-center min-h-px min-w-px py-[10px] relative w-full">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.1)] border-b border-solid inset-0 pointer-events-none" />
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[30px] min-h-px min-w-px not-italic relative text-[24px] text-black whitespace-pre-wrap">Improving coordination between departments and faculties</p>
    </div>
  );
}
...
function Frame126() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-center min-h-px min-w-px py-[10px] relative w-full">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[30px] min-h-px min-w-px not-italic relative text-[24px] text-black whitespace-pre-wrap">Generating accurate academic, financial, and regulatory reports</p>
    </div>
  );
}
...
function Frame108() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col h-[538px] items-start min-h-px min-w-px relative">
      <Frame106 />
      <Frame107 />
      <Frame109 />
      <Frame110 />
...
function Frame113() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[60px] items-start left-[200px] top-[3205px] w-[1520px]">
      <Frame111 />
      <Frame112 />
    </div>
  );
...
function Frame50() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px min-w-px relative">
      <p className="font-['Helvetica_Now_Display:Medium',sans-serif] leading-[30px] not-italic relative shrink-0 text-[#111] text-[24px]">What is a University ERP Management System?</p>
    </div>
  );
}
...
function Frame51() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px min-w-px relative">
      <p className="font-['Helvetica_Now_Display:Medium',sans-serif] leading-[30px] not-italic relative shrink-0 text-[#111] text-[24px]">Is this system suitable for both public and private universities?</p>
    </div>
  );
}
...
function Frame52() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px min-w-px relative">
      <p className="font-['Helvetica_Now_Display:Medium',sans-serif] leading-[30px] not-italic relative shrink-0 text-[#111] text-[24px] w-full whitespace-pre-wrap">Can the ERP be implemented in phases?</p>
    </div>
  );
}
...
function Frame53() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px min-w-px relative">
      <p className="font-['Helvetica_Now_Display:Medium',sans-serif] leading-[30px] not-italic relative shrink-0 text-[#111] text-[24px] w-full whitespace-pre-wrap">Will the system match our existing academic and administrative workflows?</p>
    </div>
  );
}
...
function Frame54() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px min-w-px relative">
      <p className="font-['Helvetica_Now_Display:Medium',sans-serif] leading-[30px] not-italic relative shrink-0 text-[#111] text-[24px]">How do faculty and staff adapt to the system?</p>
    </div>
  );
}
...
function Frame55() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px min-w-px relative">
      <p className="font-['Helvetica_Now_Display:Medium',sans-serif] leading-[30px] not-italic relative shrink-0 text-[#111] text-[24px] w-full whitespace-pre-wrap">Can the system scale as student numbers and programs grow?</p>
    </div>
  );
}
...
function Frame56() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px min-w-px relative">
      <p className="font-['Helvetica_Now_Display:Medium',sans-serif] leading-[30px] not-italic relative shrink-0 text-[#111] text-[24px]">Does the system support data security and institutional control?</p>
    </div>
  );
}
...
function Frame57() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px min-w-px relative">
      <p className="font-['Helvetica_Now_Display:Medium',sans-serif] leading-[30px] not-italic relative shrink-0 text-[#111] text-[24px] w-full whitespace-pre-wrap">Why choose Daffodil Software Limited for University ERP development?</p>
    </div>
  );
}
...
function Frame49() {
  return (
    <div className="-translate-x-1/2 absolute content-stretch flex gap-[40px] items-start left-1/2 px-[200px] top-[5437px] w-[1920px]">
      <Frame32 />
      <Frame31 />
    </div>
  );
...
function Frame36() {
  return (
    <div className="-translate-x-1/2 absolute bg-gradient-to-b from-white h-[730px] left-1/2 overflow-clip to-[#c4eeda] top-[6989px] w-[1920px]">
      <Frame47 />
    </div>
  );
}
...
function Frame17() {
  return (
    <div className="content-stretch flex flex-col font-['Helvetica_Now_Display:Medium',sans-serif] items-start leading-[normal] pb-[24px] relative shrink-0 text-[64px]">
      <p className="relative shrink-0">Plan a University ERP That</p>
      <p className="relative shrink-0">Grows With Your Institution</p>
    </div>
  );
}
...
function Frame45() {
  return (
    <div className="content-stretch flex flex-col items-start not-italic relative shrink-0 text-white w-full">
      <Frame17 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[30px] relative shrink-0 text-[16px] w-[629px] whitespace-pre-wrap">Whether you’re modernizing admissions, implementing a full university ERP, or replacing fragmented systems, our team helps you design a platform aligned with how your university actually operates.</p>
    </div>
  );
}
...
function Cta() {
  return (
    <div className="-translate-x-1/2 absolute bg-gradient-to-b from-white h-[872px] left-1/2 overflow-clip to-[#c4eeda] top-[6117px] w-[1920px]" data-name="CTA">
...
function Frame102() {
  return (
    <div className="absolute bg-[#f5f5f7] h-[831px] left-0 overflow-clip top-[2254px] w-[1920px]">
      <Frame89 />
    </div>
  );
}
...
function Frame94() {
  return (
    <div className="absolute content-stretch flex gap-[40px] items-center left-[200px] pb-[60px] top-[935px]">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.1)] border-b border-solid inset-0 pointer-events-none" />
      <div className="flex flex-row items-center self-stretch">
        <Frame92 />
      </div>
...
function University() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="university">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="university">
          <path d="M2 22H21.5" id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
          <path d="M3 13V22M21 13V22" id="Vector_2" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
          <path d="M7.5 8V22M16.5 8V22" id="Vector_3" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
          <path d="M2 13H7M22 13H17" id="Vector_4" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
          <path d="M6.5 8H17.5" id="Vector_5" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
          <path d={svgPaths.p3bd52d00} id="Vector_6" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
          <path d="M12 22V20" id="Vector_7" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
          <path d="M10.5 12V12.5M13.5 12V12.5" id="Vector_8" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
          <path d="M10.5 16V16.5M13.5 16V16.5" id="Vector_9" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
        </g>
      </svg>
    </div>
  );
...
function Frame13() {
  return (
    <div className="bg-[#3a986c] content-stretch flex items-center justify-center relative rounded-[10px] shrink-0 size-[40px]">
      <University />
    </div>
  );
}
...
function Frame96() {
  return (
    <div className="bg-[#f5f5f7] flex-[1_0_0] h-full min-h-px min-w-px relative rounded-[10px]">
      <div className="flex flex-col justify-end size-full">
        <div className="content-stretch flex flex-col gap-[10px] items-start justify-end px-[20px] py-[10px] relative size-full">
          <Frame13 />
          <div className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[30px] min-w-full not-italic relative shrink-0 text-[20px] text-black w-[min-content] whitespace-pre-wrap">
            <p className="mb-0">{`Public and private `}</p>
            <p>universities</p>
          </div>
        </div>
      </div>
...
function Agreement() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="agreement-02">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="agreement-02">
          <path d={svgPaths.p14ea3200} id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
          <path d="M22 14.75H19.5" id="Vector_2" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeWidth="1.5" />
          <path d="M8.5 6.75003H2" id="Vector_3" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeWidth="1.5" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="bg-[#f5f5f7] flex-[1_0_0] h-full min-h-px min-w-px relative rounded-[10px]">
      <div className="flex flex-col justify-end size-full">
        <div className="content-stretch flex flex-col gap-[10px] items-start justify-end px-[20px] py-[10px] relative size-full">
          <Frame14 />
          <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[30px] min-w-full not-italic relative shrink-0 text-[20px] text-black w-[min-content] whitespace-pre-wrap">Multi-campus and affiliated institutions</p>
        </div>
      </div>
    </div>
  );
...
function AiLearning() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="ai-learning">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="ai-learning">
          <path d="M12 15.5V20.5" id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeWidth="1.5" />
          <path d={svgPaths.p1e92f400} id="Vector_2" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
          <path d={svgPaths.p4c4c800} fill="var(--fill-0, white)" id="Vector_3" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="bg-[#f5f5f7] flex-[1_0_0] h-full min-h-px min-w-px relative rounded-[10px]">
      <div className="flex flex-col justify-end size-full">
        <div className="content-stretch flex flex-col gap-[10px] items-start justify-end px-[20px] py-[10px] relative size-full">
          <Frame16 />
          <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[30px] min-w-full not-italic relative shrink-0 text-[20px] text-black w-[min-content] whitespace-pre-wrap">Colleges operating under a central academic body</p>
        </div>
      </div>
    </div>
  );
...
function Archive() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="archive-02">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="archive-02">
          <path d={svgPaths.p7e11600} id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
          <path d={svgPaths.p3729bc40} id="Vector_2" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
          <path d={svgPaths.p3e821a80} id="Vector_3" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
          <path d={svgPaths.p126e98a0} id="Vector_4" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="bg-[#f5f5f7] flex-[1_0_0] h-full min-h-px min-w-px relative rounded-[10px]">
      <div className="flex flex-col justify-end size-full">
        <div className="content-stretch flex flex-col gap-[10px] items-start justify-end px-[20px] py-[10px] relative size-full">
          <Frame15 />
          <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[30px] min-w-full not-italic relative shrink-0 text-[20px] text-black w-[min-content] whitespace-pre-wrap">Distance learning and blended education providers</p>
        </div>
      </div>
    </div>
  );
...
function Frame82() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[24px] items-start min-h-px min-w-px not-italic relative whitespace-pre-wrap">
      <p className="font-['Helvetica_Now_Display:Medium',sans-serif] leading-[75px] relative shrink-0 text-[#111] text-[64px] w-[655px]">Designed for Institutions Managing Academic Complexity</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[30px] relative shrink-0 text-[#3c3c3c] text-[16px] w-[655px]">See why this solution is built for:</p>
    </div>
  );
}
...
function Frame101() {
  return (
    <div className="absolute content-stretch flex gap-[60px] items-start left-[200px] top-[1855px] w-[1520px]">
      <Frame100 />
      <Frame82 />
    </div>
  );
...
function HeroSection() {
  return (
    <div className="absolute h-[815px] left-0 top-0 w-[1920px]" data-name="Hero Section">
...
export default function SingleIndustryTemplatePage() {
  return (
    <div className="bg-white relative size-full" data-name="Single Industry Template Page">
      <Frame105 />
      <Frame113 />
      <Frame49 />
      <Frame36 />
