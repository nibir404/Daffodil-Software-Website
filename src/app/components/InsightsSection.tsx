...
function SecondaryCTA() {
  return (
    <button className="group relative h-[52px] rounded-[80px] px-6 overflow-hidden backdrop-blur-[10px] border border-[#111] hover:bg-[#111] transition-all">
      {/* Light Flare Effect */}
      <div className="absolute left-0 top-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 mix-blend-plus-lighter pointer-events-none">
        <div className="rotate-[-46.28deg]">
          <div className="h-[30px] w-[152px]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 260 138">
              <g filter="url(#filter0_f_secondary)" style={{ mixBlendMode: "plus-lighter" }}>
                <ellipse cx="130" cy="69" fill="white" fillOpacity="0.6" rx="76" ry="15" />
              </g>
              <defs>
                <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="138" id="filter0_f_secondary" width="260" x="0" y="0">
                  <feFlood floodOpacity="0" result="BackgroundImageFix" />
                  <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
                  <feGaussianBlur result="effect1_foregroundBlur_secondary" stdDeviation="27" />
                </filter>
              </defs>
            </svg>
          </div>
