import svgPaths from "../../imports/svg-zcwyvrsptw";
  ...
  return (
    <div className="bg-white rounded-[10px] shadow-[0px_0px_4px_0px_rgba(0,0,0,0.1)] overflow-hidden h-[503px] flex flex-col group hover:shadow-lg transition-shadow duration-300 relative">
      ...
      <div className="flex flex-col gap-4 p-5 h-full">
        {/* Product Image */}
        <div className="h-[200px] overflow-hidden rounded-[10px] relative bg-gradient-to-br from-orange-400 via-purple-500 to-pink-500">
          <img 
            src={product.image} 
            alt={product.title}
