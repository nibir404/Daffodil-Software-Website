    ...
    <section className="bg-[#0d1e32] relative py-[80px] md:py-[120px] overflow-hidden">
      ...
      <div className="max-w-[1520px] mx-auto px-6 md:px-12 lg:px-24 xl:px-[100px] relative z-10">
        <div className="flex flex-col gap-[40px] md:gap-[60px] items-center w-full">
          ...
          {/* CTA Button */}
          <button className="group backdrop-blur-[10px] border border-white border-solid rounded-[80px] px-[24px] py-[14px] relative overflow-hidden hover:bg-white/10 transition-all duration-300">
            {/* Glow Effect */}
            <div className="absolute flex h-[130.588px] items-center justify-center left-[calc(50%-63px)] mix-blend-plus-lighter top-[-39px] w-[126.735px] pointer-events-none">
            ...
            <span className="font-['Helvetica_Now_Display'] font-medium leading-[normal] text-white text-[16px] relative z-10">
