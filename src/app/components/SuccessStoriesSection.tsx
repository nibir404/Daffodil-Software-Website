...
function ViewAllButton() {
  return (
    <button className="h-[52px] rounded-[80px] border border-white border-solid relative group transition-all duration-300 hover:bg-[#111] overflow-hidden">
      ...
      <div className="content-stretch flex gap-[10px] h-full items-center px-[24px] py-[6px] rounded-[inherit] relative">
        <p className="font-['Helvetica_Now_Display'] font-medium leading-[normal] not-italic text-[16px] text-white relative z-10 transition-transform duration-300 group-hover:translate-x-0.5">
