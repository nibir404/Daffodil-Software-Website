        ...
        <div className="max-w-[1520px] mx-auto px-6 md:px-12 lg:px-24 xl:px-[100px]">
          <div className="flex items-center justify-between h-20">
            ...
            <nav className="hidden lg:flex items-center gap-0 p-[4px] rounded-[150px]">
              ...
              <button className="flex gap-[10px] items-center justify-center px-[24px] py-[10px] rounded-[150px] hover:bg-[#d5ffec] transition-colors whitespace-nowrap group">
            ...
            <div className="hidden lg:flex items-center gap-[10px] shrink-0">
              ...
              {/* CTA Button */}
              <a href="#contact" className="flex h-[52px] items-center shrink-0">
