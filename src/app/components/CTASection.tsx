...
import svgPaths from "../../imports/svg-vrs4ws700k";
      ...
      <div className="relative max-w-[1520px] mx-auto px-6 md:px-12 lg:px-24 xl:px-[100px] py-16 md:py-24 lg:py-32 w-full">
        <div className="max-w-[1200px]">
          ...
          <div className="flex flex-col sm:flex-row gap-3 md:gap-4">
            ...
            <a href="#solutions" className="inline-block w-full sm:w-auto">
              <div className="h-[48px] md:h-[52px] rounded-[80px] border border-white hover:bg-white/10 group transition-all duration-300 overflow-hidden relative backdrop-blur-[10px]">
                <div className="absolute flex h-[130.588px] items-center justify-center left-[calc(50%-98.63px)] mix-blend-plus-lighter top-[-27.29px] w-[126.735px]">
                  <div className="rotate-[-46.28deg]">
                    <div className="h-[30px] w-[152px]">
                      <div className="absolute inset-[-180%_-35.53%]">
                        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 260 138">
                          <g filter="url(#filter0_f_cta_secondary)" style={{ mixBlendMode: "plus-lighter" }}>
                            <ellipse cx="130" cy="69" fill="white" fillOpacity="0.6" rx="76" ry="15" />
                          </g>
                          <defs>
                            <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="138" id="filter0_f_cta_secondary" width="260" x="0" y="0">
                              <feFlood floodOpacity="0" result="BackgroundImageFix" />
                              <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
                              <feGaussianBlur result="effect1_foregroundBlur_cta_secondary" stdDeviation="27" />
                            </filter>
                          </defs>
                        </svg>
                      </div>
                ...
                <div className="flex gap-[10px] h-full items-center justify-center overflow-clip px-[24px] py-[6px] relative">
                  <p className="font-['Helvetica_Now_Display'] font-medium leading-normal relative text-[14px] md:text-[16px] text-white z-10">
                    Explore Solution
                  </p>
                </div>
              </div>
